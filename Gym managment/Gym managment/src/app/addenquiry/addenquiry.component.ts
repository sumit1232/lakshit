...
import {RestaurentData} from './addenquiry.model';
...
export class AddenquiryComponent implements OnInit {
  ...
  addRestaurent(){
    ...
    this.api.postenquiry(this.restaurentModelObj).subscribe(res => {
      console.log(res);
  ...
  getAllData(){
    this.api.getenquiry().subscribe(res => {
  ...
  deleteResto(data: any){
    this.api.deleteenquiry(data).subscribe((res: any) => {
      console.log(res);
  ...
  updateResto(){
    ...
    this.api.updateenquiry(this.restaurentModelObj.id,this.restaurentModelObj).subscribe((res: any) => {
